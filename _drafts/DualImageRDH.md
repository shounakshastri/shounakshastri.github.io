...
excerpt: 'In this post, I shall discuss the concepts related to Dual Image Reversible Data Hiding (DIRDH), a subject on which I have spent 5 years of my life. We will look at some basic concepts and algorithms while highlighting how these schemes are different when compared to the basic RDH schemes.'
mathjax: true
tags: 
    - Authentication
    - Image Processing
